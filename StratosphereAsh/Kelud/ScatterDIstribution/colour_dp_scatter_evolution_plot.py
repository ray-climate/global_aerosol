...
g = sns.jointplot(data=df, x="Depolarization Ratio", y="Color Ratio", hue="Aerosol Type", marker="+", s=30, color='red')  # `s` inside scatter_kws defines the size
