...
fig.suptitle('2014 Kelud: Number of Stratospheric Aerosol Layers between 9 and 25 km', fontsize=20)  # Main title
...
latitude_titles = ["Latitude: 20$^{\circ}$N to 10$^{\circ}$N", "Latitude: 10$^{\circ}$N to 10$^{\circ}$S", "Latitude: 10$^{\circ}$S to 20$^{\circ}$S"]
