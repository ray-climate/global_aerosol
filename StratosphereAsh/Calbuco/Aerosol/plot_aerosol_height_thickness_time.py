        ...
        with open(os.path.join(INPUT_PATH, file), 'r') as f:
            ...
            for row in reader:
                try:
                    ...
                    if SOUTHERN_LATITUDE <= latitude < NORTHERN_LATITUDE and MIN_ALTITUDE <= alt_base <= MAX_ALTITUDE and MIN_ALTITUDE <= alt_top <= MAX_ALTITUDE and 2. <= aerosol_type <= 2. and abs(CAD) > 9:
