...
while start_date_datetime <= end_date_datetime:
    ...
    for file in os.listdir(colocation_dir_daily):
        ...
        (footprint_lat_aeolus, footprint_lon_aeolus, footprint_time_aeolus, beta_aeolus_mb) = extract_variables_from_aeolus(aeolus_colocation_file, logger)
        print(beta_aeolus_mb.shape)
        ...
        (footprint_lat_caliop, footprint_lon_caliop, altitude_caliop, beta_caliop) = extract_variables_from_caliop(caliop_colocation_file, logger)
