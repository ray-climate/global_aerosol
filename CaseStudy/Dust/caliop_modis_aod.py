    ...
    if npz_file.endswith('.npz') & ('caliop_dbd' in npz_file):
        ...
        for file in os.listdir(MYD04_directory):
            ...
            if abs(int(hour_i) * 60 + int(minute_i) - int(hour_aqua) * 60 - int(minute_aqua)) < caliop_aqua_hour_diff * 60:
                ...
                MYD04_latitude_file = 'HDF4_EOS:EOS_SWATH:"%s":mod04:Geolocation_Fields:Latitude' % matching_MYD04_file
                MYD04_longitude_file = 'HDF4_EOS:EOS_SWATH:"%s":mod04:Geolocation_Fields:Longitude' % matching_MYD04_file
                ...
                if (lat_caliop[0] > MYD04_lat_min) & (lat_caliop[0] < MYD04_lat_max) & (lon_caliop[0] > MYD04_lon_min) & (lon_caliop[0] < MYD04_lon_max):
                ...
                if (lat_caliop[-1] > MYD04_lat_min) & (lat_caliop[-1] < MYD04_lat_max) & (lon_caliop[-1] > MYD04_lon_min) & (lon_caliop[-1] < MYD04_lon_max):
                    MODY04_colocation_file.append(matching_MYD04_file)
