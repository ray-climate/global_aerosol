...
mesh = ax.pcolormesh(resampled_timestamps, lat_grid, smoothed_aod_data, cmap='Spectral_r', vmin=0., vmax=0.5)
...
ax.set_title('AOD at aerosol layer %s - %s km [%s$^{\circ}$W - %s$^{\circ}$W]' % (alt_1, alt_2, lon1, lon2), fontsize=16, pad=15)
