...
ax.set_xticks([])
cbar = fig.colorbar(mesh, ax=ax, orientation='vertical', pad=colorbar_pad, shrink=0.8, extend='both')
...
cmap = mcolors.LinearSegmentedColormap.from_list('my_cmap', ['green', 'cyan'])
