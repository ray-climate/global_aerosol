...
plt.errorbar(lr_caliop_mean, alt_caliop, xerr=lr_caliop_std, fmt='o', color='green', ecolor='lightgreen', elinewidth=3, capsize=0, alpha=0.5)
...
for i in range(len(lr_aeolus_mean) - 1):
    ...
    plt.fill_betweenx([alt_aeolus_mean[i], alt_aeolus_mean[i + 1]], lr_aeolus_mean[i] - lr_aeolus_std[i],
                      lr_aeolus_mean[i] + lr_aeolus_std[i], color='lightblue', alpha=0.5)
