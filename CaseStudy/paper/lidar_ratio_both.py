...
for i in range(len(lr_aeolus_mean) - 1):
    plt.errorbar([lr_aeolus_mean[i], lr_aeolus_mean[i]], [alt_aeolus_mean[i], alt_aeolus_mean[i + 1]], xerr=lr_aeolus_std[i],  fmt='o', color='blue', ecolor='lightblue', elinewidth=3, capsize=0)
