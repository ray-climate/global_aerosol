...
ax2.errorbar(grouped_data_day_days, grouped_data_day['thickness_mean'], yerr=grouped_data_day['thickness_std'], fmt='*', color='black', markeredgecolor='black', capsize=3, elinewidth=2.4)
